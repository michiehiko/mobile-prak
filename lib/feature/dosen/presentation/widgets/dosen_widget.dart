...
// Pake relative path biar ga error URI
...
// -----------------------------------------------------------------------------
// TAMBAHAN WIDGET DARI GEMINI: DosenListView (Biar dosen_page.dart nggak error!)
// -----------------------------------------------------------------------------
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          // Otomatis muterin warna gradien yang udah dibikin di constants.dart
          ...
          return ModernDosenCard(
            ...
            onTap: () {
              // Bisa diisi aksi pas card dosen di-klik nanti
            },
          );
        },
      ),
